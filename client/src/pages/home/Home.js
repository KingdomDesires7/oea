          ...
          <div className="iPadShell">
            ...
            <div className="iPadContentSpace">
              ...
              <div onMouseEnter={() => mouseOverIcon('tree')} onMouseLeave={() => mouseLeaveIcon()} className="treeContainerB">
                  ...
                  <Link to="/tree">
                    <div onClick={()=>treeClicked()} onMouseEnter={() => mouseOverIcon('lawyer')} onMouseLeave={() => mouseLeaveIcon()} className="lawyerContainerB">
                        <button src={doctor} alt='' className="lawyer" ></button>
                    </div>
                  </Link>
                </div>
              </>
